...
public class UnitTestRunner {
    public String runTests(String filename, String path) {
        Runtime runtime = Runtime.getRuntime();

        try {
            String command = "java -cp /Library/JUNIT/junit-4.12.jar:/Library/JUNIT/hamcrest-core-1.3.jar:" + path + " org.junit.runner.JUnitCore " + filename;
